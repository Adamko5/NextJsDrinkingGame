...
import styles from './WitchitaDeceptia1.module.css';
import { WitchitaDeceptia1Dialogue } from '@/constants/dialogue';
...
export default function WitchitaDeceptia1() {
  ...
  return (
    <div className={styles.container}>
      <VideoPlayer src="/videos/WitchitaDeceptia.mp4" onVideoEnded={onVideoEnded} fadeMs={FADE_MS} holdMs={HOLD_MS} />

      {showDialogue && (
        <div className={styles.dialogueWrapper}>
          <Dialogue1 dialogue={WitchitaDeceptia1Dialogue} onDialogueComplete={handleDialogueComplete} />
        </div>
      )}
